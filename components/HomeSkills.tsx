...
function SkillBox({ skill }: { skill: SkillTag }) {
  return (
    <li className="relative flex min-h-[3.75rem] items-center justify-center rounded-md border border-border-light bg-white px-4 py-3 text-center text-meta font-medium leading-snug text-ink-dark shadow-sm transition-shadow hover:shadow-md">
